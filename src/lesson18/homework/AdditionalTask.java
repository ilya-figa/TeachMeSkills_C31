...
public class AdditionalTask {
    ...
    public static List<String> getMapIdName(Map<Integer,String> integerStringMap){
        return integerStringMap.keySet().stream().filter(integerList::contains).filter(id->integerStringMap.get(id).length() % 2 == 1).collect(Collectors.toMap(k->k, integerStringMap::get))
